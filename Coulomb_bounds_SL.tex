...
\begin{align}
	...
	&\quad + C_\varepsilon C^m k_{\F}^{-1} \Xi^{\half - \varepsilon} \eva{a_q^* a_q}^{\half} e(q)^{-\half} \;. \label{eq:estEQ211}
\end{align}
\end{lemma}
...
\begin{align}
	...
	&\leq C_\varepsilon (C \hat{V}(\ell))^m
		\hat{V}(\ell_1)
		k_{\F}^{-1} e(q)^{-\half} \Xi^{\half-\varepsilon} \eva{a_q^* a_q}^{\half} \;. \label{eq:estEQ2113_bis}
\end{align}
}
\end{proof}
