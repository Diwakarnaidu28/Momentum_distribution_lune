...
\end{align}
In case $ \sum_\ell \hat{V}(\ell) < \infty $, the term $ |\I_m(\ell, \ell_1)| $ for $ E^{m,2}_{Q_2} $ is bounded as in~\eqref{eq:estEQ2113}.
}
\end{proof}
