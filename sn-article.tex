...
\begin{align}
	&\abs{\sum_{\ell \in S} \I_\ell } \nonumber\\
	&\leq \sum\limits_{\ell \in S, \ell_1\in \Z^3_*} \sum\limits_{r\in L_{\ell} \cap L_{\ell_1}}
		\norm{ K^m(\ell)_{r,q} K(\ell_1)_{r,-r+\ell+\ell_1} a_{r-\ell_1} a_{r-\ell-\ell_1} b_{q}(\ell) (\NN+1)^{-\alpha} \psi}
		\norm{(\NN+5)^\alpha \psi} \nonumber\\
	&\leq \sum\limits_{\ell \in S, \ell_1\in \Z^3_*} 
		\left( \sum\limits_{r\in L_{\ell} \cap L_{\ell_1}} |K^m(\ell)_{r,q}| |K(\ell_1)_{r,-r+\ell+\ell_1}| \right)
		\max_{r' \in \Z^3_*} \norm{ a_{r'-\ell_1} a_{r'-\ell-\ell_1} a_{q-\ell} a_q (\NN+1)^{-\alpha} \psi}
		\norm{(\NN+5)^\alpha \psi} \nonumber\\
	&\leq \left( \sum\limits_{\ell \in S, \ell_1\in \Z^3_*} 
		\sum\limits_{r\in L_{\ell} \cap L_{\ell_1}}		|K^m(\ell)_{r,q}|^2
		\sum\limits_{r'\in L_{\ell} \cap L_{\ell_1}} |K(\ell_1)_{r',-r'+\ell+\ell_1}|^2 \right)^{\frac 12} \times \nonumber\\
	&\quad \times \left( \sum\limits_{\ell \in S, \ell_1 \in \Z^3_*}
		\max_{r'} \norm{a_{q-\ell} a_{r'-\ell_1}a_q (\NN+1)^{-\alpha} \psi}^2 \right)^{\frac 12}
		\norm{(\NN+5)^\alpha \psi} \nonumber\\
\end{align}
\textcolor{red}{[SL: Actually, these sums cannot be converted that easily]}
On the other hand
\begin{align}
	&\abs{\sum_{\ell \in \Z^3_* \setminus S} \I_\ell } \nonumber\\
	&\leq \sum_{\ell \in \Z^3_* \setminus S} \sum\limits_{\ell_1\in \Z^3_*} \sum\limits_{r\in L_{\ell} \cap L_{\ell_1}}
		\norm{ K^m(\ell)_{r,q} K(\ell_1)_{r,-r+\ell+\ell_1} a_{r-\ell_1} a_{r-\ell-\ell_1} b_{q}(\ell) (\NN+1)^{-\alpha} \psi}
		\norm{(\NN+5)^\alpha \psi} \nonumber\\
	&\leq \sum_{\ell \in \Z^3_* \setminus S} \left( \sum\limits_{\ell_1\in \Z^3_*} \sum\limits_{r\in L_{\ell} \cap L_{\ell_1}}
	...
	&\quad \times \left( \sum\limits_{\ell_1, r \in \Z^3_*}
		...
		\norm{(\NN+5)^\alpha \psi} \nonumber\\
\end{align}
\textcolor{red}{[SL: Also here, there are conversion problems. The proof below also does not seem to work.]}
%TODO Writing head
