...
\begin{align}
    ...
    &\leq \abs{ \sum_{\ell \in \Z^3_* \setminus S} \sum\limits_{r \in L_\ell} \eva{ b_{q}(\ell)
    		\sum\limits_{\ell_1 \in \Z^3_*}  \sum\limits_{s_1 \in L_{\ell_1}} K(\ell_1)_{r,s_1} b_{-s_1}(-\ell_1) a_{r-\ell_1} \psi, 
    		 K^m_{r,q}(\ell) a_{r-\ell} \psi }}\nonumber\\
    &\leq \left( \sum_{\ell \in \Z^3_* \setminus S} \sum_{r \in L_\ell}
    		\norm{a_{q-\ell} a_q \sum\limits_{\ell_1 \in \Z^3_*} \sum_{s_1 \in L_{\ell_1}} K(\ell_1)_{r,s_1} b_{-s_1}(-\ell_1) a_{r-\ell_1} (\NN+1)^{-\alpha} \psi}^2 \right)^{\frac 12} \times \nonumber\\
    	...
    	&\leq \left( \sum_{r \in \Z^3_*}
    		\norm{\sum\limits_{\ell_1 \in \Z^3_*} \sum_{s_1 \in L_{\ell_1}} K(\ell_1)_{r,s_1} b_{-s_1}(-\ell_1) a_{r-\ell_1} a_q (\NN+1)^{\frac 12-\alpha} \psi}^2 \right)^{\frac 12} \times \nonumber\\
...
\begin{equation}
	\abs{\sum_{\ell \in \Z^3_* \setminus S} \I_{\ell,\ell_1}}
...
\begin{align}
	...
	&\leq \sum_{\ell \in S} \abs{ \sum\limits_{r \in L_\ell} \eva{ b_{q}(\ell)
    	...
    	&\leq \sum_{\ell \in S} \left( \sum_{r \in \Z^3_*}
    		\norm{\sum\limits_{\ell_1 \in \Z^3_*} \sum_{s_1 \in L_{\ell_1}} K(\ell_1)_{r,s_1} b_{-s_1}(-\ell_1) a_{r-\ell_1} a_q (\NN+1)^{-\alpha} \psi}^2 \right)^{\frac 12} \times \nonumber\\
    	&\quad \times \left( \norm{K^m(\ell)}_{\max}^2
    		\sum_{r \in L_\ell} \norm{ a_{r-\ell} (\NN+5)^{\alpha}\psi }^2 \right)^{\frac 12} \nonumber\\
    	&\leq \sum_{\ell \in S} \norm{K^m(\ell)}_{\max}
...
To bound the $ \II $-term, we proceed similarly.
