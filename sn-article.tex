...
\begin{proof}
    ...
    \begin{align}
        (\ref{eq:exp_w/o_err})&=\half\Bigg(-\frac{\lambda}{1!}\sum\limits_{\ell\in \Z^3_*}\sum\limits_{r\in L_\ell} \big\{K(\ell),\{K(\ell),\Delta^q\}\big\}_{r,r}\nonumber \\ &- \frac{\lambda^3}{3!}\sum\limits_{\ell\in \Z^3_*}\sum\limits_{r\in L_\ell} \big\{K(\ell),\big\{K(\ell),\big\{K(\ell),\{K(\ell),\Delta^q\}\big\}\big\}\big\}_{r,r} - \cdots  \nonumber\\
