...
\begin{definition}[Bootstrap Quantity]
 For $k \in \Z^3_*$ and $q\in L_k$, we have 
    ...
    and we also denote
    \begin{equation}
         \Xi_\lambda^{\half} \coloneq \sup\limits_{q \in L_k}\norm{n_q T_\lambda\Omega}
    \end{equation}
\end{definition}
...
\begin{alignat}{2}
    ...
    \Big( 2a^*_{r+\ell_1}b^*_{s+\ell}(\ell) b^*_{-s_1-\ell_1}(-\ell_1) a_{r+\ell}\nonumber \\ &+ b^*_{s+\ell}(\ell) a^*_{r+\ell_1}[b_{-s_1-\ell_1}(-\ell_1),a^*_{r+\ell}]^*+ \mathrm{h.c.} \Big)
    \end{aligned}\\
\end{alignat}
and
\begin{alignat}{2}
    ...
    \end{aligned}\\
    &\quad -\!\!\!\sum\limits_{\ell,\ell_1 \in \Z^3_*}\begin{aligned}[t]&\sum\limits_{\substack{r\in (L_{\ell}-\ell) \cap (L_{\ell_1}-\ell_1)\\ s \in L_{\ell},s_1\in L_{\ell_1}}}\!\!\!\!\!\!\begin{aligned}[t] A(\ell)_{r+\ell,s+\ell} K(\ell_1)_{r+\ell_1,s_1+\ell_1} &\Big(4a^*_{r+\ell_1}b^*_{-s_1}(-\ell_1)b_{-s}(-\ell)a_{r+\ell} \nonumber\\ 
...
\begin{alignat}{2}
    ...
    &-\sum\limits_{\ell, \ell_1\in \Z^3_*}\!\!
        \sum\limits_{\substack{r\in L_{\ell}\cap L_{\ell_1}\\s \in L_{\ell}, s_1\in L_{\ell_1}}} \!\!\!\!\!\! \mathds{1}_{L_\ell}(q)\begin{aligned}[t] \bigg(\sum_{j=1}^{m-1}K^{m-j}_{r,q}(\ell&)K^{j}_{q,s}(\ell)\bigg)K_{r,s_1}(\ell_1)\times\\&\times\!\Big( 2a^*_{r-\ell_1}b^*_{s}(\ell) b^*_{-s_1}(-\ell_1)a_{r-\ell} -\delta_{-s_1+\ell_1,r-\ell} b^*_{s}(\ell) a^*_{r-\ell_1}a^*_{-s_1}\Big)
        \end{aligned}\nonumber\\
    &- \sum\limits_{\ell, \ell_1\in \Z^3_*}\!\! \sum\limits_{ \substack{r \in         (L_{\ell}-\ell) \\ \phantom{r\in} \cap\\\phantom{r\in}(L_{\ell_1}-\ell_1)     \\ s \in L_{\ell},s_1\in L_{\ell_1}}}\!\!\!\!\!\!\mathds{1}_{L_\ell}(q)       \begin{aligned}[t] \bigg(\sum_{j=1}^{m-1} K^{m-j}_{r+\ell,q}(\ell&)           K^{j}_{q,s}(\ell)\bigg) K_{r+\ell_1,s_1}(\ell_1) \times \\ &\times\!\Big(     2a^*_{r+\ell_1} b^*_{s}(\ell) b^*_{-s_1}(-\ell_1) a_{r+\ell} + \delta_{-      s_1,r+\ell} b^*_{s}(\ell) a^*_{r+\ell_1}a^*_{-s_1+\ell_1}\Big)
        \end{aligned}\nonumber\\
    ...
    &-\sum\limits_{\ell, \ell_1\in \Z^3_*}  \!\quad                      
        \sum\limits_{\substack{s \in L_{\ell} \\ s_1 \in L_{\ell_1}}}\!\,  \mathds{1}_{L_\ell}(q) \mathds{1}_{L_{\ell_1}}(q) K^{m}_{q,s}(\ell) K_{q,s_1}(\ell_1)\Big( 2a^*_{q} b^*_{s}(\ell) b^*_{-s_1}(-\ell_1) a_{q}\nonumber + \delta_{-s_1,q} b^*_{s}(\ell) a^*_{q}a^*_{-s_1+\ell_1}\Big)
        \nonumber\\
...
\begin{alignat}{2}
    ...
    &-\sum\limits_{\ell, \ell_1\in \Z^3_*}\!
        ...
        &+ 2\delta_{-s_1,r+\ell}\delta_{q-\ell,s_1-\ell_1}a^*_{r+\ell_1}a_{-q} + 2\delta_{-q,r+\ell}b^*_{-s_1}(-\ell_1)a_{-q+\ell}a_{r+\ell}\nonumber\\
    ...
    &-\sum\limits_{\ell, \ell_1\in \Z^3_*}\!
        ...
        \end{aligned}\nonumber\\
    &-\sum\limits_{\ell, \ell_1\in \Z^3_*}\!\!
        \sum\limits_{\substack{r \in (L_{\ell}-\ell) \\ \phantom{r\in} \cap \\ \phantom{r\in}  (L_{\ell_1}-\ell_1)\\s\in L_{\ell},s_1\in L_{\ell_1}}}\begin{aligned}[t]\!\!\!\!\!\mathds{1}_{L_\ell}&(q)\bigg(\sum_{j=1}^{m-1}K^{m-j}_{r+\ell,q}(\ell)K^{j}_{q,s}(\ell)\bigg) 
        ...
        &+ 2\delta_{-s_1,r+\ell}\delta_{s-\ell,s_1-\ell_1}a^*_{r+\ell_1}a_{-s} + 2\delta_{-s,r+\ell}b^*_{-s_1}(-\ell_1)a_{-s+\ell}a_{r+\ell} \nonumber\\
        &+2\delta_{-s,r+\ell_1}\delta_{-s+\ell,-s_1+\ell_1}a^*_{-s_1}a_{r+\ell} + \delta_{-s_1,r_\ell}\delta_{-s,r+\ell_1}a^*_{-s_1+\ell_1}a_{-s+\ell}\nonumber\\
        &+ \big\{ [b_{-s}(-\ell),a^*_{r+\ell_1}],[a^*_{r+\ell}, b_{-s_1}(-\ell_1)]^*\big\} \Big)
        \end{aligned}\nonumber\\
    &- \sum\limits_{\ell, \ell_1\in \Z^3_*}\!\quad\sum\limits_{\substack{s \in        L_{\ell}\\s_1\in L_{\ell_1}}}\begin{aligned}[t]\,                             \mathds{1}_{L_\ell}&(q) \mathds{1}_{L_{\ell_1}}(q) K^{m}_{q,s}(\ell)          K_{q,s_1}(\ell_1) \Big( 4a^*_{q-\ell_1} b^*_{-s_1}(-\ell_1) b_{-s}(-\ell)     a_{q-\ell} \nonumber\\ 
        ...
        \end{aligned}\nonumber\\
    &-\sum\limits_{\ell, \ell_1\in \Z^3_*}\!\quad\sum\limits_{\substack{s \in L_{\ell}\\     s_1 \in L_{\ell_1}}} \begin{aligned}[t]\, \mathds{1}_{L_\ell}&       (q) \mathds{1}_{L_{\ell_1}}(q) K^{m}_{q,s}(\ell) K_{q,s_1}        (\ell_1) \Big(4a^*_{q}b^*_{-s_1}(-\ell_1)b_{-s}(-\ell)a_{q}       \nonumber\\ 
        &+ 2a^*_{q}[b_{-s}(-\ell),b^*_{-s_1}(-\ell_1)]a_{q}- \delta_{-s_1, q}a^*_{q}a^*_{-s_1+\ell_1}b_{-s}(-\ell) \nonumber\\
        &+ 2\delta_{-s_1,q}\delta_{s-\ell,s_1-\ell_1}a^*_{q}a_{-s} + 2\delta_{-s,q}b^*_{-s_1}(-\ell_1)a_{-s+\ell}a_{q} \nonumber\\
        &+2\delta_{-s,q}\delta_{-s+\ell,-s_1+\ell_1}a^*_{-s_1}a_{q} + \delta_{-s_1,q_\ell}\delta_{-s,q}a^*_{-s_1+\ell_1}a_{-s+\ell} \nonumber\\
        &+ \big\{ [b_{-s}(-\ell),a^*_{q}],[a^*_{q}, b_{-s_1}(-\ell_1)]^*\big\} \Big)
        \end{aligned}\nonumber\\
    &+\mathrm{h.c.} + (q\rightarrow-q)\nonumber\\
    &-\sum\limits_{\ell \in \Z^3_*}\sum\limits_{r,s \in L_{\ell}}\Theta^{m+1}_K(P^q)_{r,s}\epsilon_{r,s}(\ell,\ell)
    \equalscolon \sum\limits_{i=1}^{6}\sum\limits_{j=1}^{8} E_{Q_2}^{\,i,j}\nonumber + E_{Q_2}^{\, 7}.
 \end{alignat}
with all the terms $E_{Q_1}^{i,j}, E_{Q_2}^{i,j}$ and $E{Q_2}^{7}$ having the contributions from both $q$ and $-q$ momenta. These terms either have six, four, two or no fermionic operator. Next we bound these error terms and in order to do so we have the following estimates. As evident from the normal ordering, the first term, i.e.,  $E_{Q_1}^{i,1}, E_{Q_2}^{i,1}$ have six fermionic operators each. These estimates are not exhaust all the error terms but present the technique required to bound them all.
...
\end{lemma}
\begin{proof}
We start by using resolution of the identity $I = (\NN+1)^{\alpha}(\NN+1)^{-\alpha}$ for some $\alpha \in \R$. Then use the Cauchy-Schwarz inequality and the bounds from Lemma \ref{lem:pairest} on the L.H.S. of (\ref{eq:headboserra})
\begin{align}
