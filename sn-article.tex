...
\begin{align}
	...
	&\leq \sum\limits_{\ell, \ell_1\in \Z^3_*} \mathds{1}_{L_{\ell}}(q) \sum\limits_{\substack{r\in L_{\ell} \cap L_{\ell_1}\\s_1\in L_{\ell_1}}} \abs{\eva{\psi, K^m(\ell )_{r,q} K(\ell_1)_{r,s_1} a^*_{r-\ell_1} b^*_{q}(\ell) b^*_{-s_1}(-\ell_1) a_{r-\ell} \psi }}\\
	&\quad + \sum\limits_{\ell, \ell_1\in \Z^3_*} \sum\limits_{j=1}^{m-1} {{m}\choose j} \mathds{1}_{L_{\ell}}(q) \sum\limits_{\substack{r\in L_{\ell} \cap L_{\ell_1}\\ s \in L_{\ell},s_1\in L_{\ell_1}}}  \abs{\eva{\psi,  K^{m-j}(\ell)_{r,q} K^{j}(\ell)_{q,s} K(\ell_1)_{r,s_1} a^*_{r-\ell_1} b^*_{s}(\ell) b^*_{-s_1}(-\ell_1) a_{r-\ell} \psi }} \\
	&\quad +\sum\limits_{\ell, \ell_1\in \Z^3_*} \mathds{1}_{L_{\ell}}(q) \mathds{1}_{L_{\ell_1}}(q) \sum\limits_{s \in L_{\ell},s_1\in L_{\ell_1}} \abs{\eva{\psi, K^m(\ell)_{q,s}K(\ell_1)_{q,s_1}
	a^*_{q-\ell_1}b^*_{s}(\ell) b^*_{-s_1}(-\ell_1)a_{q-\ell} \psi }}\\
	&=: \sum_{\ell, \ell_1 \in \Z^3_*} (\I_{\ell,\ell_1} + \II_{\ell,\ell_1} + \III_{\ell,\ell_1})
\end{align}
...
\begin{align}
	&\sum_{\ell, \ell_1 \in S} \I_{\ell,\ell_1} \\
    &\leq \sum\limits_{\ell,\ell_1 \in S}\!\! \mathds{1}_{L_\ell}(q)
    		\sum\limits_{r \in L_\ell \cap L_{\ell_1}}
    		\abs{\eva{ \sum\limits_{s_1 \in L_{\ell_1}} K(\ell_1)_{r,s_1} b_{-s_1}(-\ell_1) a_{r-\ell_1} K^{m}_{r,q}(\ell) b_{q}(\ell) (\NN+1)^{\alpha} (\NN+1)^{-\alpha} \psi, 
    		 a_{r-\ell} \psi }}\nonumber\\
    &\leq \sum\limits_{\ell,\ell_1 \in S} \!\!\mathds{1}_{L_\ell}(q)
    		\sum\limits_{r \in L_\ell \cap L_{\ell_1}}
    		\norm{\sum\limits_{s_1 \in L_{\ell_1}} K(\ell_1)_{r,s_1} b_{-s_1}(-\ell_1) a_{r-\ell_1} K^{m}_{r,q}(\ell) b_{q}(\ell) (\NN+1)^{-\alpha}\psi}
    		\norm{  a_{r-\ell} (\NN+5)^{\alpha}\psi } \nonumber\\
    &\leq \sum\limits_{\ell,\ell_1 \in S} \!\mathds{1}_{L_\ell}(q) \sum\limits_{r \in L_\ell\cap L_{\ell_1}} 
