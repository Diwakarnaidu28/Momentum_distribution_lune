...
\begin{lemma}[Bounds on $ K $]
	...
	\begin{equation} \label{eq:K_element_bounds}
		|(K(\ell)^m)_{r,s}|
		\le \frac{(C \hat{V}(\ell))^m k_{\mathrm{F}}^{-1}}{\lambda_{\ell,r} + \lambda_{\ell,s}} \;.
	\end{equation}
...
\begin{equation} \label{eq:K_max_bounds}
	...
	\le (C \hat{V}(\ell))^m k_{\mathrm{F}}^{-1} \;, \qquad
	\Vert K(\ell)^m \Vert_{\mathrm{max},2}
	\le (C \hat{V}(\ell))^m |k|^{\frac{11}{6}} k_{\mathrm{F}}^{-\frac 23} \log(k_{\mathrm{F}})^{\frac 13} \;.
\end{equation}
\end{lemma}
\begin{proof}
...
\begin{equation}
	|K(\ell)_{r,s}|
	\le C \frac{\hat{V}(\ell) k_{\mathrm{F}}^{-1}}{\lambda_{\ell,r} + \lambda_{\ell,s}} \;.
\end{equation}
For $ m \ge 2 $, we proceed by induction: Suppose, \eqref{eq:K_element_bounds} was shown to hold until $ m-1 $. Then, using $ \lambda_{\ell,r} > 0 $ and \textcolor{red}{[CHN22, Prop.~A.2]} $ \sum_{r \in L_\ell} \lambda_{\ell,r}^{-1} \le C k_{\mathrm{F}} $, we get
\begin{equation}
	\begin{aligned}
		|(K(\ell)^m)_{r,s}|
		&\le \sum_{r' \in L_\ell}
		|(K(\ell)^{m-1})_{r,r'}| \;
		|K(\ell)_{r',s}|
		\le (C \hat{V}(\ell))^m k_{\mathrm{F}}^{-2} \sum_{r' \in L_\ell}
		\frac{1}{\lambda_{\ell, r} + \lambda_{\ell, r'}}
		\frac{1}{\lambda_{\ell, r'} + \lambda_{\ell, s}} \\
		&\le (C \hat{V}(\ell))^m k_{\mathrm{F}}^{-2} \sum_{r' \in L_\ell}
		\frac{1}{\lambda_{\ell, r'} (\lambda_{\ell, r} + \lambda_{\ell, s})}
		\le (C \hat{V}(\ell))^m k_{\mathrm{F}}^{-1}
		\frac{1}{\lambda_{\ell, r} + \lambda_{\ell, s}} \;.
	\end{aligned}
\end{equation}
The first bound in \eqref{eq:K_max_bounds} then follows immediately noting that $ \lambda_{\ell,r} \ge \frac 12 $ uniformly in $ \ell, r $. For the second bound in \eqref{eq:K_max_bounds}, we proceed as in \textcolor{red}{[CHN22, Prop.~7.2]}: Using that \textcolor{red}{[CHN22, Prop.~A.3]} for all $ \beta < -\frac 43 $,
\begin{equation}
	\sum_{r \in L_\ell} \lambda_{\ell,r}^{-\beta}
	\le C |k|^{\frac{11}{3}} k_{\mathrm{F}}^{\frac 23} \log(k_{\mathrm{F}})^{\frac 23} \;,
\end{equation}
we get with $ \beta = 2 $:
\begin{equation}
	\Vert K(\ell)^m \Vert_{\mathrm{max},2}^2
	= \sup_{q \in \Z^3} \sum_{r \in L_\ell} |(K(\ell)^m)_{r,q}|^2
	\le \sup_{q \in \Z^3} \sum_{r \in L_\ell} (C \hat{V}(\ell))^{2m} k_{\mathrm{F}}^{-2} \lambda_{\ell,r}^{-2}
	\le (C \hat{V}(\ell))^{2m} |k|^{\frac{11}{3}} k_{\mathrm{F}}^{-\frac 43} \log(k_{\mathrm{F}})^{\frac 23} \;.
\end{equation}
Taking the square root implies the second bound in \eqref{eq:K_max_bounds}.\\
\end{proof}
...
\begin{align}
	&\eqref{eq:EQ1111}\nonumber\\
    &= \sum\limits_{\ell,\ell_1 \in \Z^3_*}\!\! \mathds{1}_{L_\ell}(q) \sum\limits_{r \in L_\ell \cap L_{\ell_1}} \abs{\eva{ \sum\limits_{s_1 \in L_{\ell_1}} K(\ell_1)_{r,s_1} b_{-s_1}(-\ell_1) K^{m}_{r,q}(\ell) b_{q}(\ell) a_{r-\ell_1} (\NN+1)^{\alpha} (\NN+1)^{-\alpha} \psi,  a_{r-\ell} \psi }}\nonumber\\
    &\leq \sum\limits_{\ell,\ell_1 \in \Z^3_*} \!\!\mathds{1}_{L_\ell}(q) \sum\limits_{ r \in L_\ell \cap L_{\ell_1}} \abs{\eva{ \sum\limits_{s_1 \in L_{\ell_1}} K(\ell_1)_{r,s_1} b_{-s_1}(-\ell_1) K^{m}_{r,q}(\ell) b_{q}(\ell) a_{r-\ell_1} (\NN+1)^{-\alpha} \psi, a_{r-\ell} (\NN+5)^{\alpha} \psi }}\nonumber\\
    &\leq \sum\limits_{\ell,\ell_1 \in \Z^3_*} \!\!\mathds{1}_{L_\ell}(q) \sum\limits_{r \in L_\ell \cap L_{\ell_1}}    \norm{\sum\limits_{s_1 \in L_{\ell_1}} K(\ell_1)_{r,s_1} b_{-s_1}(-\ell_1) K^{m}_{r,q}(\ell) b_{q}(\ell) a_{r-\ell_1} (\NN+5)^{-\alpha}\psi}\norm{  a_{r-\ell} (\NN+5)^{\alpha}\psi } \nonumber\\
