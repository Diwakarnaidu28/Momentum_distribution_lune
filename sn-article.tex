...
\begin{align}
	&\eqref{eq:EQ1113}\nonumber\\
	&\leq\sum\limits_{\ell, \ell_1\in \Z^3_*} \mathds{1}_{L_{\ell}}(q) \!\!\! \sum\limits_{s \in L_{\ell},s_1\in L_{\ell_1}}\!\! \mathds{1}_{L_{\ell_1}}(q) \abs{\eva{ K^m(\ell)_{q,s}K(\ell_1)_{q,s_1} b_{-s_1}(-\ell_1) b_{s}(\ell) a_{q-\ell_1} (\NN+1)^{-\alpha}\psi, a_{q-\ell} (\NN+3)^{\alpha} \psi }}\nonumber\\
	&\leq\sum\limits_{\ell, \ell_1\in \Z^3_*} \mathds{1}_{L_{\ell}}(q) \!\!\! \sum\limits_{s \in L_{\ell},s_1\in L_{\ell_1}}\!\! \mathds{1}_{L_{\ell_1}}(q) \norm{ K^m(\ell)_{q,s}K(\ell_1)_{q,s_1} b_{-s_1}(-\ell_1) b_{s}(\ell) a_{q-\ell_1} (\NN+1)^{-\alpha}\psi}\norm{ a_{q-\ell} (\NN+3)^{\alpha} \psi }\nonumber\\
	&\leq\sum\limits_{\ell, \ell_1\in \Z^3_*} \mathds{1}_{L_{\ell}}(q)\norm{K^m(\ell)}_{\mathrm{max}} \norm{ K(\ell_1)}_{\mathrm{max}} \! \mathds{1}_{L_{\ell_1}}(q) \norm{ a_{q-\ell_1} (\NN+1) (\NN+1)^{-\alpha} \psi} \norm{ a_{q-\ell} (\NN+3)^{\alpha} \psi }\nonumber
\end{align}
For $\alpha=1$
\begin{equation}
	\leq\sum\limits_{\ell, \ell_1\in \Z^3_*} \mathds{1}_{L_{\ell_1}}(q)\norm{K^m(\ell)}_{\mathrm{max}} \norm{ K(\ell_1)}_{\mathrm{max}} \! \mathds{1}_{L_{\ell}}(q) \norm{ a_{q-\ell_1} \psi} \norm{ a_{q-\ell} (\NN+3) \psi }\nonumber
\end{equation}
...
\end{align}
Then adding \eqref{eq:estEQ1111},\eqref{eq:estEQ1112} and \eqref{eq:estEQ1113}, we arrive at the bound above.
\end{proof}
