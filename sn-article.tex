...
\begin{definition}[Norms]
	...
	\begin{align}
		\norm{A(k)}_{\mathrm{max}} &\coloneq \sup\limits_{p,q \in \Z^3}\abs{A(k)_{p,q}},\\
		\norm{A(k)}_{\mathrm{max,1}} &\coloneq \sup\limits_{q \in \Z^3}\sum\limits_{p \in \Z^3}\abs{A(k)_{p,q}}
	\end{align}
	and
	\begin{equation}
		\norm{A(k)}_{\mathrm{max},2} \coloneq \sup\limits_{q \in \Z^3}\bigg(\sum\limits_{p \in \Z^3}\abs{A(k)_{p,q}}^2\bigg)^\half.
	\end{equation}
\end{definition}
...
\begin{align}
    ...
    &\leq \sum\limits_{\ell \in \Z^3_*} \!\!\mathds{1}_{L_\ell}(q) \Bigg(\sum\limits_{\ell_1 \in \Z^3_*}\sup_{r \in \Z^3}\sum\limits_{s_1 \in L_{\ell_1}}\abs{K(\ell_1)_{r,s_1}}^2\Bigg)^\half \Bigg(\sum\limits_{\ell_1 \in \Z^3_*} \sum\limits_{r \in L_{\ell_1}}  \sum\limits_{s_1 \in L_{\ell_1}} \norm{ b_{-s_1}(-\ell_1) b_{q}(\ell) a_{r-\ell_1} (\NN+1)^{-\alpha}\psi}^2\Bigg)^\half \times\nonumber\\
    &\quad \times  \norm{  K^{m}(\ell)}_{\mathrm{max}} \norm{ \NN^\half (\NN+5)^{\alpha}\psi } \nonumber\\
    &\leq \sum\limits_{\ell \in \Z^3_*} \!\!\mathds{1}_{L_\ell}(q) \bigg(\sum\limits_{\ell_1 \in \Z^3_*} \norm{K(\ell_1)}_{\mathrm{max,2}}^2 \bigg)^\half \Bigg(   \sum\limits_{\ell_1 \in \Z^3_*} \sum\limits_{s_1 \in L_{\ell_1}} \sum\limits_{r \in \Z^3_*} \norm{ b_{-s_1}(-\ell_1) b_{q}(\ell) a_{r-\ell_1} (\NN+1)^{-\alpha}\psi}^2\Bigg)^\half \times\nonumber\\
    &\quad \times  \norm{  K^{m}(\ell)}_{\mathrm{max}} \norm{ \NN^\half (\NN+5)^{\alpha}\psi } \nonumber\\
    &\leq \sum\limits_{\ell \in \Z^3_*} \!\!\mathds{1}_{L_\ell}(q) \bigg(\sum\limits_{\ell_1 \in \Z^3_*} \norm{K(\ell_1)}_{\mathrm{max,2}}^2 \bigg)^\half \Bigg( \sum\limits_{s_1 \in \Z^3}  \sum\limits_{\ell_1 \in \Z^3_*} \mathds{1}_{L_{\ell_1}}(s_1) \sum\limits_{r \in \Z^3} \norm{ a_{r-\ell_1} a_{-s_1+\ell_1} a_{-s_1}  a_{q}(\NN+1)^{-\alpha}\psi}^2\Bigg)^\half \times\nonumber\\
    &\quad \times  \norm{  K^{m}(\ell)}_{\mathrm{max}} \norm{ \NN^\half (\NN+5)^{\alpha}\psi } \nonumber\\
    &\leq \sum\limits_{\ell \in \Z^3_*}\mathds{1}_{L_\ell}(q) \norm{  K^{m}(\ell)}_{\mathrm{max}}  \bigg(\sum\limits_{\ell_1 \in \Z^3_*} \norm{K(\ell_1)}_{\mathrm{max,2}}^2 \bigg)^\half  \norm{   a_{q}(\NN+1)^{\frac{3}{2}-\alpha}\psi} \norm{ \NN^\half (\NN+5)^{\alpha}\psi } \nonumber\\
\end{align}
wherein we use $\NN<(\NN+1)<(\NN+5)$ and $\NN^\half(\NN+5)^{\frac{3}{2}}\leq C(\NN+1)^{2}$. Then for $\alpha = \frac{3}{2}$, we have
\begin{align}
    ...
    \eqref{eq:EQ1111}&\leq C\, \Xi^\half \sum\limits_{\ell \in \Z^3_*} \norm{K(\ell)}_{\mathrm{max}}\Bigg( \sum\limits_{\ell_1 \in \Z^3_*}\norm{K(\ell_1)}_{\mathrm{max,2}}^2 \Bigg)^\half  \norm { (\NN+1)^{2} \psi }. \label{eq:estEQ1111}    
\end{align}
...
\begin{align}
	...
	&\quad \times  \norm{  K^{m}(\ell)}_{\mathrm{max}} \norm{ \NN^\half(\NN+5)^{\alpha}\psi } \nonumber\\
	&\leq \sum\limits_{\ell \in \Z^3_*} \!\!\mathds{1}_{L_\ell}(q) \Bigg(\sum\limits_{\ell_1 \in \Z^3_*}\sup_{r \in \Z^3}\sum\limits_{s_1 \in L_{\ell_1}}\abs{K(\ell_1)_{r+\ell_1,s_1}}^2\Bigg)^\half \Bigg(\sum\limits_{\ell_1 \in \Z^3_*} \sum\limits_{r \in \Z^3}  \sum\limits_{s_1 \in L_{\ell_1}} \norm{ b_{-s_1}(-\ell_1) b_{q}(\ell) a_{r+\ell_1} (\NN+1)^{-\alpha}\psi}^2\Bigg)^\half \times\nonumber\\
	&\quad \times  \norm{  K^{m}(\ell)}_{\mathrm{max}} \norm{ \NN^\half (\NN+5)^{\alpha}\psi } \nonumber\\
	&\leq \sum\limits_{\ell \in \Z^3_*}\mathds{1}_{L_\ell}(q) \norm{  K^{m}(\ell)}_{\mathrm{max}}  \bigg(\sum\limits_{\ell_1 \in \Z^3_*} \norm{K(\ell_1)}_{\mathrm{max,2}}^2 \bigg)^\half  \norm{   a_{q}(\NN+1)^{\frac{3}{2}-\alpha}\psi} \norm{ \NN^\half (\NN+5)^{\alpha}\psi } \nonumber\\
\end{align}
wherein we use $\NN<(\NN+1)<(\NN+5)$ and $\NN^\half(\NN+5)^{\frac{3}{2}}\leq C(\NN+1)^{2}$. Then for $\alpha = \frac{3}{2}$, we have
\begin{align}
	%&\leq C\sum\limits_{\ell,\ell_1 \in \Z^3_*} \mathds{1}_{L_\ell}(q) \norm{K(\ell)}_{\mathrm{max}}\norm{K(\ell_1)}_{\mathrm{max}}  \norm{b_{q}(\ell) \psi} \norm { (\NN+1)^{\frac{3}{2}} \psi }\nonumber\\
	%&\leq C \sup\limits_{q \in L_\ell} \norm{n_{q}^{\half} \psi} \sum\limits_{\ell,\ell_1 \in \Z^3_*} \norm{K(\ell)}_{\mathrm{max}}\norm{K(\ell_1)}_{\mathrm{max}} \norm { (\NN+1)^{\frac{3}{2}} \psi }\nonumber\\
	\eqref{eq:EQ1211}&\leq C\, \Xi^\half \sum\limits_{\ell \in \Z^3_*} \norm{K(\ell)}_{\mathrm{max}}\Bigg( \sum\limits_{\ell_1 \in \Z^3_*}\norm{K(\ell_1)}_{\mathrm{max,2}}^2 \Bigg)^\half  \norm { (\NN+1)^{2} \psi }. \label{eq:estEQ1211}    
\end{align}
We estimate \eqref{eq:EQ1212} as 
\begin{alignat}{2}
	&\eqref{eq:EQ1212}\nonumber\\
	&\leq \sum\limits_{j=1}^{m-1} {{m}\choose j} \sum\limits_{\ell, \ell_1\in \Z^3_*} \mathds{1}_{L_{\ell}}(q)\!\! \sum\limits_{r\in (L_{\ell}-\ell) \cap (L_{\ell_1}-\ell_1)}\! \norm{ \sum\limits_{s \in L_\ell, s_1 \in L_{\ell_1}} K^{j}(\ell)_{q,s} K(\ell_1)_{r+\ell_1,s_1} b_{-s_1}(-\ell_1) b_{s}(\ell) a_{r+\ell_1}\psi}\norm{  K^{m-j}(\ell)_{r+\ell,q} a_{r+\ell} \psi } \nonumber\\
	&\leq \sum\limits_{j=1}^{m-1} {{m}\choose j} \sum\limits_{\ell, \ell_1\in \Z^3_*} \mathds{1}_{L_{\ell}}(q)\!\! \sum\limits_{r\in (L_{\ell}-\ell) \cap (L_{\ell_1}-\ell_1)}\! \Bigg( \sum\limits_{s \in L_\ell}\begin{aligned}[t]
		\abs{K^{j}(\ell)_{q,s}}^2\Bigg)^\half &\norm{ \sum\limits_{ s_1 \in L_{\ell_1}}  K(\ell_1)_{r+\ell_1,s_1} b_{-s_1}(-\ell_1)  a_{r+\ell_1}\psi}\times\nonumber\\ \times&\norm{  K^{m-j}(\ell)_{r+\ell,q} a_{r+\ell} \psi }
	\end{aligned} \nonumber\\
	&\leq \sum\limits_{j=1}^{m-1} {{m}\choose j} \sum\limits_{\ell, \ell_1\in \Z^3_*} \mathds{1}_{L_{\ell}}(q) \norm{K^{j}(\ell)}_{\mathrm{max,2}} \Bigg( \sum\limits_{r\in  (L_{\ell_1}-\ell_1)}\! \norm{ \sum\limits_{ s_1 \in L_{\ell_1}}  K(\ell_1)_{r+\ell_1,s_1} b_{-s_1}(-\ell_1)  a_{r+\ell_1}\psi} ^2\Bigg)^\half \times\nonumber\\ &\quad\times\Bigg( \sum\limits_{r\in (L_{\ell}-\ell) }\!\norm{  K^{m-j}(\ell)_{r+\ell,q} a_{r+\ell} \psi }^2\Bigg)^\half\nonumber\\
	&\leq \sum\limits_{j=1}^{m-1} {{m}\choose j} \sum\limits_{\ell, \ell_1\in \Z^3_*} \norm{K^{m-j}(\ell)}_{\mathrm{max,2}} \norm{K^{j}(\ell)}_{\mathrm{max,2}} \Bigg( \sum\limits_{r\in (L_{\ell_1}-\ell_1)}\! \norm{ \sum\limits_{ s_1 \in L_{\ell_1}}  K(\ell_1)_{r+\ell_1,s_1} b_{-s_1}(-\ell_1)  a_{r+\ell_1}\psi} ^2\Bigg)^\half \sup_{r \in \Z^3}\norm{a_r\psi}\nonumber\\
	...
	&\leq \Xi^\half \sum\limits_{j=1}^{m-1} {{m}\choose j} \sum\limits_{\ell \in \Z^3_*} \norm{K^{m-j}(\ell)}_{\mathrm{max,2}} \norm{K^{j}(\ell)}_{\mathrm{max,2}} \Bigg(\sum\limits_{ \ell_1\in \Z^3_*}\norm{  K(\ell_1)}_{\mathrm{max,2}}^2\Bigg)^\half \Bigg( \sum\limits_{ \ell_1\in \Z^3_*} \sum\limits_{ s_1 \in L_{\ell_1}}\norm{   a_{-s_1+\ell_1}a_{-s_1} \NN^\half \psi} ^2\Bigg)^\half \nonumber\\
	&\leq \Xi^\half \sum\limits_{j=1}^{m-1} {{m}\choose j} \sum\limits_{\ell \in \Z^3_*} \norm{K^{m-j}(\ell)}_{ \mathrm{max,2} } \norm{K^{j}(\ell)}_{\mathrm{max,2}} \Bigg(\sum\limits_{ \ell_1\in \Z^3_*}\norm{  K(\ell_1)}_{\mathrm{max,2}}^2\Bigg)^\half  \norm{\NN^2 \psi} \label{eq:estEQ1212}
\end{alignat} 
...
\begin{align}
	...
	&\leq\quad C\, \Xi^{\half} \left(\sum\limits_{\ell_1\in \Z^3_*} \norm{K(\ell_1)}_{\mathrm{max}} \right) \left(\left(\sum\limits_{\ell\in \Z^3_*} \norm{K^m(\ell)}_{\mathrm{max,2}}^2  \right)^\half  \norm{(\NN+1) \psi} \right.\nonumber\\ 
	&\quad +\left.\left(  \sum\limits_{j=1}^{m-1} {{m}\choose j} \sum\limits_{\ell \in \Z^3_*} \norm{K^{m-j}(\ell)}_{\mathrm{max,2}} \norm{ K^{j}(\ell)}_{\mathrm{max,1}}\right) \norm{(\NN+1)^\half
		 \psi }\right) \label{eq:estEQ112}
\end{align}
\end{lemma}
\begin{proof}
...
\begin{align}
	 ...
	 &\leq \sum\limits_{\ell_1\in \Z^3_*}  \norm{K(\ell_1) }_{\mathrm{max}} \norm{  (\NN+5)^{\alpha} \psi} \Bigg( \sum\limits_{\ell\in \Z^3_*} \norm{ K^m(\ell)}_{\mathrm{max,2}}^2 \Bigg)^\half \Bigg( \sum\limits_{\ell\in \Z^3_*} \mathds{1}_{L_{\ell}}(q) \norm{  a_{q-\ell}a_q (\NN+1)^{\half-\alpha} \psi }^2 \Bigg)^\half \nonumber\\
	 &\leq \sum\limits_{\ell_1\in \Z^3_*} \mathds{1}_{L_{\ell}}(q) \norm{K(\ell_1) }_{\mathrm{max}} \norm{  (\NN+5)^{\alpha} \psi} \Bigg( \sum\limits_{\ell\in \Z^3_*} \norm{ K^m(\ell)}_{\mathrm{max,2}}^2 \Bigg)^\half  \norm{ a_q (\NN+1)^{1-\alpha} \psi } \nonumber\\
\end{align}
wherein we used $\norm{a_p} \leq \mathds{1}$, $\sum_{p\in \Z^3_*}\norm{a_p \psi}^2\leq\norm{\NN\psi}^2<\norm{(\NN+2)\psi}^2$ and $(\NN+5)\leq C(\NN+1)$. Then for $\alpha = 1$, we have
\begin{equation}
	\eqref{eq:EQ1121}\leq C\, \Xi^\half \Bigg( \sum\limits_{\ell\in \Z^3_*} \norm{ K(\ell)}_{\mathrm{max,2}}^2 \Bigg)^\half \left(\sum\limits_{\ell_1\in \Z^3_*} \norm{K(\ell_1)}_{\mathrm{max}} \right) \norm{(\NN+1)^1 \psi} \label{eq:estEQ1121}
\end{equation} 
...
\begin{align}
	...
	&\leq\sum\limits_{\ell, \ell_1\in \Z^3_*} \mathds{1}_{L_{\ell}}(q) \mathds{1}_{L_{\ell_1}\cap(-L_{\ell_1}+\ell+\ell_1)}(q)\norm{(\NN+5)^{\alpha} \psi} \norm{K(\ell_1)}_{\mathrm{max}} \Bigg( \sum\limits_{s \in L_{\ell}} \abs{K^m(\ell)_{q,s}}^2\Bigg)^\half \Bigg(\sum\limits_{s \in L_{\ell}} \norm{ a_{s-\ell} a_{q-\ell_1} a_s (\NN+1)^{-\alpha} \psi  }^2\Bigg)^\half \nonumber\nonumber\\
	&\leq\sum\limits_{\ell_1\in \Z^3_*} \mathds{1}_{L_{\ell}}(q) \mathds{1}_{L_{\ell_1}\cap(-L_{\ell_1}+\ell+\ell_1)}(q)\norm{(\NN+5)^{\alpha} \psi} \norm{K(\ell_1)}_{\mathrm{max}} \Bigg( \sum\limits_{\ell\in \Z^3_*} \norm{K^m(\ell)}_{\mathrm{max,2}}^2\Bigg)^\half \times \nonumber\\ 
	&\quad\times \Bigg(\sum\limits_{s \in L_{\ell}} \sum\limits_{\ell\in \Z^3_*} \mathds{1}_{L_\ell}(s) \norm{ a_{s-\ell} a_s a_{q-\ell_1}  (\NN+1)^{-\alpha} \psi  }^2\Bigg)^\half \nonumber\nonumber\\
	&\leq\sum\limits_{ \ell_1\in \Z^3_*} \mathds{1}_{L_{\ell}}(q) \mathds{1}_{L_{\ell_1}\cap(-L_{\ell_1}+\ell+\ell_1)}(q)\norm{(\NN+5)^{\alpha} \psi} \norm{K(\ell_1)}_{\mathrm{max}} \Bigg( \sum\limits_{\ell\in \Z^3_*} \norm{K^m(\ell)}_{\mathrm{max,2}}^2\Bigg)^\half \Bigg(\sum\limits_{\ell\in \Z^3_*} \sum\limits_{s \in L_{\ell}} \norm{  a_{q-\ell_1}  (\NN+1)^{1-\alpha} \psi  }^2\Bigg)^\half \nonumber\nonumber\\
\end{align}
For $\alpha=1$, we have
\begin{align}
	&\leq C\sum\limits_{ \ell_1\in \Z^3_*} \mathds{1}_{L_{\ell}}(q) \mathds{1}_{L_{\ell_1}\cap(-L_{\ell_1}+\ell+\ell_1)}(q)  \Bigg( \sum\limits_{\ell\in \Z^3_*} \norm{K^m(\ell)}_{\mathrm{max,2}}^2\Bigg)^\half \norm{K(\ell_1)}_{\mathrm{max}} \norm{a_{q-\ell_1} \psi } \norm{(\NN+1) \psi}\nonumber\\
	\eqref{eq:EQ1123}&\leq C\: \Xi^\half   \Bigg( \sum\limits_{\ell\in \Z^3_*} \norm{K^m(\ell)}_{\mathrm{max,2}}^2\Bigg)^\half \left(\sum\limits_{ \ell_1\in \Z^3_*} \norm{K(\ell_1)}_{\mathrm{max}} \right)  \norm{(\NN+1) \psi}\label{eq:estEQ1123}
\end{align}
...
\begin{proof}
  ...
  \begin{align}
  	&\eqref{eq:EQ2111}\nonumber\\
  	&= \sum\limits_{\ell,\ell_1 \in \Z^3_*}\!\! \mathds{1}_{L_\ell}(q) \sum\limits_{\substack{r \in L_\ell \cap L_{\ell_1}\\ s_1 \in L_{\ell_1}}} \abs{\eva{ K^{m}(\ell)_{r,q} b_{q}(\ell) a_{r-\ell_1} (\NN+1)^{\alpha} (\NN+1)^{-\alpha} \psi, K(\ell_1)_{r,s_1} b_{-s_1}(-\ell_1) a_{r-\ell} \psi}}\nonumber\\
  	&\leq \sum\limits_{\ell,\ell_1 \in \Z^3_*} \!\!\mathds{1}_{L_\ell}(q) \sum\limits_{\substack{r \in L_\ell \cap L_{\ell_1}\\ s_1 \in L_{\ell_1}}} \abs{\eva{ K^{m}(\ell)_{r,q} b_{q}(\ell) a_{r-\ell_1} (\NN+1)^{-\alpha} \psi, K(\ell_1)_{r,s_1} b_{-s_1}(-\ell_1) a_{r-\ell} (\NN+1)^{\alpha} \psi }}\nonumber\\
