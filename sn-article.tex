...
For \eqref{eq:EQ1111}-\eqref{eq:EQ1113}, we start by using resolution of the identity $I = (\NN+1)^{\alpha}(\NN+1)^{-\alpha}$ for some $\alpha \in \R$. Then use the Cauchy-Schwarz inequality and the bounds from Lemma \ref{lem:pairest}. We estimate \eqref{eq:EQ1111} as 
\begin{align}
	&\eqref{eq:EQ1111}\nonumber\\
    ...
    &\leq \sum\limits_{\ell,\ell_1 \in \Z^3_*} \mathds{1}_{L_\ell}(q) \norm{K^{m}(\ell)}_{\mathrm{max}}\norm{K(\ell_1)}_{\mathrm{max}} \Bigg(\sum\limits_{r \in L_{\ell_1}} \norm{ b_{q}(\ell) \left(\NN+1\right) (\NN+1)^{-\alpha} \psi}^2\Bigg)^\half\!\!\Bigg( \sum\limits_{r \in L_\ell} \norm { \NN^\half (\NN+3)^{\alpha} \psi }^2\Bigg)^\half\nonumber
\end{align}
wherein we used $\sum_{p\in \Z^3_*}\norm{a_p \psi}^2\leq\norm{\NN\psi}^2<\norm{(\NN+2)\psi}^2$, $\sum_{p\in L_{\ell}}\norm{b_p({\ell}) \psi}^2\leq\norm{\NN\psi}^2<\norm{(\NN+3)\psi}^2$ and $\NN(\NN+3)^\half\leq C(\NN+1)^{\frac{3}{2}}$. Then for $\alpha = 1$, we have
\begin{align}
...
\end{align}
where the last inequality is implied by Remark \ref{q-q}. Then we use the decomposition of $\Theta^m_{K}(P^q)$.
For \eqref{eq:EQ1211}-\eqref{eq:EQ1213}, we start by using resolution of the identity $I = (\NN+1)^{\alpha}(\NN+1)^{-\alpha}$ for some $\alpha \in \R$. Then use the Cauchy-Schwarz inequality and the bounds from Lemma \ref{lem:pairest}. We estimate \eqref{eq:EQ1211} as
\begin{alignat}{2}
	&\eqref{eq:EQ1211}\nonumber\\
...
\end{align}
where the last inequality is implied by Remark \ref{q-q}. Then we use the decomposition of $\Theta^m_{K}(P^q)$.
For \eqref{eq:EQ1121}-\eqref{eq:EQ1123}, we start by using resolution of the identity $I = (\NN+1)^{\alpha}(\NN+1)^{-\alpha}$ for some $\alpha \in \R$. Then use the Cauchy-Schwarz inequality and the bounds from Lemma \ref{lem:pairest}. 
...
\begin{proof}
  ...
  \begin{align}
  	...
  	+\,4&\sum\limits_{\ell, \ell_1\in \Z^3_*} \mathds{1}_{L_{\ell}}(q) \mathds{1}_{L_{\ell_1}}(q) \sum\limits_{s \in L_{\ell},s_1\in L_{\ell_1}} \abs{\eva{\psi,  K^m(\ell)_{q,s}K(\ell_1)_{q,s_1}
  	a^*_{q-\ell_1} b^*_{s}(\ell) b^*_{-s_1}(-\ell_1) a_{q-\ell} \psi}} \label{eq:EQ2113}
  \end{align}
  where the last inequality is implied by Remark \ref{q-q}. Then we use the decomposition of $\Theta^m_{K}(P^q)$.
  For \eqref{eq:EQ2111}-\eqref{eq:EQ2113}, we start by using resolution of the identity $I = (\NN+1)^{\alpha}(\NN+1)^{-\alpha}$ for some $\alpha \in \R$. Then use the Cauchy-Schwarz inequality and the bounds from Lemma \ref{lem:pairest}. 
  We estimate \eqref{eq:EQ2111} as 
...
\begin{proof}
 ...
 \end{align}
 where the last inequality is implied by Remark \ref{q-q}. Then we use the decomposition of $\Theta^m_{K}(P^q)$.
 For \eqref{eq:EQ2211}-\eqref{eq:EQ2213}, we start by using resolution of the identity $I = (\NN+1)^{\alpha}(\NN+1)^{-\alpha}$ for some $\alpha \in \R$. Then use the Cauchy-Schwarz inequality and the bounds from Lemma \ref{lem:pairest}.
...
\begin{proof}
    ...
    \end{align}
    where the last inequality is implied by Remark \ref{q-q}. Then we use the decomposition of $\Theta^m_{K}(P^q)$.
    For \eqref{eq:EQ2121}-\eqref{eq:EQ2123}, we start by using resolution of the identity $I = (\NN+1)^{\alpha}(\NN+1)^{-\alpha}$ for some $\alpha \in \R$. Then use the Cauchy-Schwarz inequality and the bounds from Lemma \ref{lem:pairest}.
