...
\end{equation}
We have
\[\epsilon_{p,q}(\ell,k) = \epsilon^*_{q,p}(k,\ell) \qquad \textnormal{and} \qquad \epsilon_{p,p}(k,k)\leq 0 \;.\]
\end{lemma}
The proof is simple by the CAR. As an immediate consequence we obtain the following commutation lemma.
...
To simplify the Duhamel expansion, we introduce the $n$-fold anticommutator
