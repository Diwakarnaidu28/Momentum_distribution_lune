...
\end{align*}
The $ E_{Q_1}$-- and $ E_{Q_2} $--terms are not expanded further but collected in the error operator, and the $ \{A,K\} $-terms are extracted as leading-order contributions. The result after $ n $ expansion steps is
\begin{equation}
\begin{aligned}
