...
The next estimate generalizes \cite[Prop.~5.8]{CHN21}, conceptually going back to \cite{BJPSS16,BPS14}. It shows that the expectation value $ \langle \Omega, e^{\lambda S} (\mathcal{N} + 1)^m e^{-\lambda S} \Omega \rangle$ does not grow with $N$.
