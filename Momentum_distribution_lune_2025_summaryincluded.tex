...
\begin{align*}
	...
	&\leq \Bigg( \sum_{r \in L_{\ell_1}} \Bigg\Vert \sum_{s_1 \in L_{\ell_1}} K(\ell_1)_{r,s_1} b_{-s_1}(-\ell_1) b_{q}(\ell) a_{r-\ell_1} (\NN+1)^{-1}\xi_\lambda \Bigg\Vert^2\Bigg)^\half \nonumber\\
	&\quad \times \Bigg( \sum_{r \in L_\ell} \norm{  K^{m}(\ell)_{r,q} a_{r-\ell} (\NN+5)\xi_\lambda }^2\Bigg)^\half \nonumber\\
	&\leq \Bigg( \sum_{r,s_1 \in L_{\ell_1}}\abs{K(\ell_1)_{r,s_1}}^2 \sum_{s_1' \in L_{\ell_1}} \norm{ b_{-s_1'}(-\ell_1) b_{q}(\ell) a_{r-\ell_1} (\NN+1)^{-1}\xi_\lambda}^2\Bigg)^\half \nonumber\\
	& \quad \times (C \hat{V}(\ell))^m k_{\F}^{-1} e(q)^{-1} \norm{ \NN^\half(\NN+5)\xi_\lambda } \nonumber\\
	&\leq (C \hat{V}(\ell))^m k_{\F}^{-1} e(q)^{-1}  \norm{K(\ell_1)}_{\mathrm{max,2}} \norm{ a_{q}\xi_\lambda} \norm{ (\NN+5)^{\frac{3}{2}}\xi_\lambda } \tagg{eq:notimportant2} \;.
\end{align*}
