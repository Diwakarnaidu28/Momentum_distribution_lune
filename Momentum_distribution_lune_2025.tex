...
\begin{equation} \label{eq:EQ1EQ2extension}
	...
	= \sum_{j=1}^3 E_{Q_1}^{m,j} \;, \qquad
	E_{Q_2}(\Theta^m_{K}(P^q)) 
	= \sum_{j=1}^{11} E_{Q_1}^{m,j} + n_q^{\ex,m} \;,
\end{equation}
with
\begin{align}
	E_{Q_1}^{m,1}
...
\begin{align}
	...
	E_{Q_2}^{m,10}
	&:= \frac 32 \sum\limits_{\ell \in \Z^3_*} \sum\limits_{r\in L_{\ell}}\Theta^{m+1}_{K}(P^q)(\ell)_{r,r} a^*_{r-\ell}a_{r-\ell} \nonumber\\
	E_{Q_2}^{m,11}
	&:= \frac 32 \sum\limits_{\ell \in \Z^3_*} \sum\limits_{r\in L_{\ell}}\Theta^{m+1}_{K}(P^q)(\ell)_{r,r} a^*_{r}a_{r} \nonumber\\
	n_q^{\ex,m}
